...
public interface IOpdVisitService
{
    ...
    Task<IReadOnlyList<OpdVisitDto>> GetByPatientAsync(int patientId, int branchId);
    Task<IReadOnlyList<OpdVisitDto>> GetByDoctorAsync(int doctorId, int branchId, DateTime? date = null);
